...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, ativo) values (1, 'Thai Gourmet', 10, 1, (now() at time zone 'utc'), (now() at time zone 'utc'), 1, '38400-999', 'Rua João Pinheiro', '1000', 'Centro', true);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo) values (2, 'Thai Delivery', 9.50, 1, (now() at time zone 'utc'), (now() at time zone 'utc'), true);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo) values (3, 'Tuk Tuk Comida Indiana', 15, 2, (now() at time zone 'utc'), (now() at time zone 'utc'), true);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo) values (4, 'Java Steakhouse', 12, 3, (now() at time zone 'utc'), (now() at time zone 'utc'), true);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo) values (5, 'Lanchonete do Tio Sam', 11, 4, (now() at time zone 'utc'), (now() at time zone 'utc'), true);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo) values (6, 'Bar da Maria', 6, 4, (now() at time zone 'utc'), (now() at time zone 'utc'), true);
...
insert into usuario (id, nome, email, senha, data_cadastro) values (1, 'Lucas Guimaraes', 'lucasguiamrasr12321@gmail.com', 'Lucas123', (now() at time zone 'utc'));
insert into usuario (id, nome, email, senha, data_cadastro) values (2, 'Joao Carlos', 'joaocarlos2010@gmail.com', 'Joao123', (now() at time zone 'utc'));
insert into usuario (id, nome, email, senha, data_cadastro) values (3, 'Pedro Cleber', 'cleber.pedro@gmail.com', 'Pedro123', (now() at time zone 'utc'));
